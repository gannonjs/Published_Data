...
Hydra $\mathrm{I}$ UDG 11 is in the Hydra $\mathrm{I}$ cluster. The magnitude was converted to $g$ band using the listed $g-r$ colour in \citet{Iodice2020} and then transformed to $V$-band assuming $V = g-0.3$. The data for this galaxy are taken from the works of \citet{Iodice2020}, \citet{Iodice2023}, \citet{Buttitta2025} and \citet{Doll2026}.

\subsection{Hydra $\mathrm{I}$ UDG1 / UDG 12 / UDG 4 / UDG 7 / UDG9}
These UDGs are in the Hydra $\mathrm{I}$ cluster. For UDG 7 and UDG 12 \citet{Butitta2025} warns the values of their dispersion (and hence other quantities such as masses derived from them) may be overestimated. The magnitudes were converted to $g$ band using the listed $g-r$ colour in \citet{Iodice2020} and then transformed to $V$-band assuming $V = g-0.3$. Globular cluster counts are those within 5 Re from \citet{Iodice2020}. The data for these galaxies are taken from the works of \citet{Iodice2020}, \citet{Buttitta2025} and \citet{Doll2026}.
...
\begin{itemize}
    ...
    \item We exclude the galaxy Hydra $\mathrm{I}$ UDG 1 as it is too bright and the galaxy Hydra $\mathrm{I}$ UDG 8 as it is too small to meet our definition. Both are from the study of \citet{Buttitta2025}.
    \item We exclude the galaxy FCC 224 published by \citet{Tang2025} and {Buzzo2025} as it is slightly too bright to meet our UDG definition. 
\end{itemize}
