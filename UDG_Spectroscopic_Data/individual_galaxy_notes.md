...
### VCC 1287
Notes: 
$a$ = This galaxy is also identified as NGVSUDG-14 in \citet{Lim2020}. 
$b$ = we preference the GC velocity dispersion and GC counts of \citet{Beasley2016} due to their lower uncertainties. 
...
$d$ = Note the $N_{\rm GC}$ quoted in the abstract is slightly different to this value. Here we use the value from Table 1 of \citet{vanDokkum2017}. Although see \citet{Saifollahi2021, Saifollahi2022} for a differing view of the GC richness of Dragonfly~44. 
...
$c$ = it is unclear if the velocity dispersion is also effected by the barycentric correction issue described in footnote 16 of \citet{vanDokkum2019b}. 
$d$ = for a differeing view of the GC richness of DFX1 see \citet{Saifollahi2022}
Data sources: \citet{vanDokkum2017, Gannon2021}. 

### NGC 5846 UDG1
Notes: 
$a$ = This galaxy is also referred to as MATLAS-2019 in the MATLAS dwarf galaxy catalog \citep{Habas2020, Muller2020, Muller2021}. 
$b$ = Surface brightness using the properties listed in Table 1 of \citet{Forbes2019} and equation 11 of \citet{Graham2005}. Transformed from $g$-band using $V = g-0.3$. 
$c$ = We preference the velocity dispersion and redshift from \citet{Forbes2021} over those reported in \citet{Muller2020} due to the greater instrumental resolution of Keck/KCWI over VLT/MUSE. 
$d$ = We preference the distance/GC richness from \citet{Danieli2022} over those reported in \citet{Muller2021} due to the deeper \textit{HST} data used. 
Data sources: \citet{Muller2020, Muller2021, Forbes2021, Danieli2022}.

### VLSB-B
Notes: 
$a$ = This galaxy is also identified as NGVSUDG-11 in \citet{Lim2020}. 
$b$ = Vega magnitude.
$c$ = Half-light radius circularised using literature ellipticity.
$d$ = Many of the properties presented in the table were updated in \citet{toloba2023| from those listed in \citet{Toloba218}
...
$a$ = This galaxy is also identified as NGVSUDG-04 in \citet{Lim2020}. 
$b$ = Vega magnitude.
$c$ = Half-light radius circularised using literature ellipticity.
$d$ = Many of the properties presented in the table were updated in \citet{toloba2023| from those listed in \citet{Toloba218}
Data sources: \citet{Toloba2018, Lim2020, Toloba2023}
...
### VCC 615
Notes: 
$a$ = This galaxy is also identified as NGVSUDG-A04 in \citet{Lim2020}. 
$b$ = Vega magnitude. 
$c$ = Half-light radius circularised using literature ellipticity.
...
$b$ = M_r transformed to $V$-band using stated $g-r$ colour and $V=g-0.3$. 
$c$ = Surface brightness using the properties listed for the single S\'ersic fit in Table 1 of \citet{Gannon2021} and equation 11 of \citet{Graham2005}.
...
$c$ = Surface brightness calculated using the properties listed for the single S\'ersic fit in Table 2 of \citet{Cohen2018} and equation 11 of \citet{Graham2005}. 
$d$ = We preference the recessional velocity and velocity dispersion values reported by \citet{Danieli2019} over those reported in \citet{Emsellem2019} due to the greater instrumental resolution of Keck/KCWI over VLT/MUSE.
$e$ = For the GC counts we use the value of GCs in the roughly expected GC luminosity function window as reported by \citet{Shen2021}. This value excludes the brighter sub-population. 
...
### VCC 811
$a$ = This galaxy is also known as NGVSUDG-05
$b$ = Vega magnitude. 
$c$ = Beware, half-light radius may not be circularised and is likely semi-major
Data sources: \citet{Lim2018, Toloba2023}.

### VCC 1017
$a$ = This galaxy is also known as NGVSUDG-09
$b$ = Vega magnitude. 
$c$ = Beware, half-light radius may not be circularised and is likely semi-major
Data sources: \citet{Lim2018, Toloba2023}.

### VCC 1052
$a$ = This galaxy is also known as NGVSUDG-10
$b$ = Vega magnitude. 
$c$ = Beware, half-light radius may not be circularised and is likely semi-major
Data sources: \citet{Lim2018, Toloba2023}.
